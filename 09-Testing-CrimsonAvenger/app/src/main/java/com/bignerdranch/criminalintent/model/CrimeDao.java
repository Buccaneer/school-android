...
public class CrimeDao extends AbstractDao<Crime, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property SuspectMail = new Property(5, String.class, "suspectMail", false, "SUSPECT_MAIL");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CRIME\" (" + //
                ...
                "\"SUSPECT_MAIL\" TEXT," + // 5: suspectMail
                "\"PHOTO\" TEXT);"); // 6: photo
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Crime entity) {
        ...
        String suspectMail = entity.getSuspectMail();
        if (suspectMail != null) {
            stmt.bindString(6, suspectMail);
        }
    ...
    public Crime readEntity(Cursor cursor, int offset) {
        Crime entity = new Crime( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // suspectMail
    ...
    public void readEntity(Cursor cursor, Crime entity, int offset) {
        ...
        entity.setSuspectMail(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
